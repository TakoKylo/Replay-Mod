...
{
    public static class ReplayModConstants
    {
        ...
        public const int ReplayDtoFormatVersion = 4;
        public const int ReplayBinaryFormatVersion = 4;
        public const int ReplaySummaryCacheVersion = 6;
